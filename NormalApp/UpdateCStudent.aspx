<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/NormalApp.Master" AutoEventWireup="true" CodeBehind="UpdateCStudent.aspx.cs" Inherits="OIMS.NormalApp.UpdateCStudent" %>
    ...
    <table class="style1" cellpadding="2px">
        <tr>
            <td colspan="3" style="text-align: center">
                <h4>Update Computer Student Information</h4></td>
        </tr>
        <tr>
            <td>
                Student Id (cstd_id):</td>
            <td colspan="2">
                <asp:TextBox ID="txtCStdId" runat="server" Width="193px" 
...
<div class="rightappcontent">
    <table class="style1" cellpadding="5px">
        <tr>
            <td colspan="3" style="text-align: center">
                <h4>Update Computer Fee Information</h4></td>
        </tr>
        <tr>
            <td>
                Student Id (cstd_id):</td>
            <td style="margin-left: 40px" colspan="2">
                <asp:TextBox ID="txtCStdIdF" runat="server" Width="193px" 
                    ValidationGroup="SearchCFGroup"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="txtCStdIdF" CssClass="errorMessage" 
   ...
   <div class="bottommenu">
       <ul>
        <li><a href="../NormalApp/AdmitCStudent.aspx">Admit Computer Student</a></li>  
        <li><a href="../NormalApp/UpdateCStudent.aspx">Update Computer Student</a></li>
        <li><a href="../NormalApp/DisplayCStudent.aspx">Display Computer Student</a></li>
        </ul>
