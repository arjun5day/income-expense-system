<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/NormalApp.Master" AutoEventWireup="true" CodeBehind="UpdatePStudent.aspx.cs" Inherits="OIMS.NormalApp.UpdatePStudent" %>
    ...
    <table class="style1" cellpadding="2px">
        <tr>
            <td colspan="3" style="text-align: center">
                <h4>Update Prepration Student Information</h4></td>
        </tr>
        <tr>
            <td>
                Student Id (Pstd_id):</td>
            <td colspan="2">
                <asp:TextBox ID="txtPStdId" runat="server" Width="193px" 
        ...
        <tr>
            <td colspan="3">
                <asp:Literal ID="ltrPMessage" runat="server"></asp:Literal>
            </td>
        </tr>
        <tr>
            <td>
...
<div class="rightappcontent">
    <table class="style1" cellpadding="5px">
        <tr>
            <td colspan="3" style="text-align: center">
                <h4>Update Prepration Fee Information</h4></td>
        </tr>
        <tr>
            <td>
                Student Id (Pstd_id):</td>
            <td style="margin-left: 40px" colspan="2">
                <asp:TextBox ID="txtPStdIdF" runat="server" Width="193px" 
                    ValidationGroup="SearchCFGroup"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="txtPStdIdF" CssClass="errorMessage" 
        ...
        <tr>
            <td colspan="3">
                <asp:Literal ID="ltrPFee" runat="server"></asp:Literal>
            </td>
        </tr>
        <tr>
            <td>
   ...
   <div class="bottommenu">
       <ul>
        <li><a href="../NormalApp/AdmitCStudent.aspx">Admit Prepration Student</a></li>  
        <li><a href="../NormalApp/UpdateCStudent.aspx">Update Prepration Student</a></li>
