<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/NormalApp.Master" AutoEventWireup="true" CodeBehind="AdmitLStudent.aspx.cs" Inherits="OIMS.NormalApp.AdmitLStudent" %>
    ...
    <table class="style1" cellpadding="5px">
        <tr>
            <td colspan="2" style="text-align: center">
                <h4>Language Student Admission</h4></td>
        </tr>
        <tr>
            <td class="style2">
                First Name:</td>
...
<div class="rightappcontent">
    <table class="style1" cellpadding="5px">
        <tr>
            <td colspan="2" style="text-align: center">
                <h4>Language Fee Information</h4></td>
        </tr>
        <tr>
            <td>
                Course:</td>
            <td style="margin-left: 40px">
                <asp:DropDownList ID="ddCourse" runat="server" Width="193px">
                    <asp:ListItem>Basic Level</asp:ListItem>
  ...
  <div class="bottommenu">
       <ul>
        <li><a href="../NormalApp/AdmitLanguae.aspx">Admit Language Student</a></li>  
        <li><a href="../NormalApp/UpdateLStudent.aspx">Update Language Student</a></li>
        <li><a href="../NormalApp/DisplayLStudent.aspx">Display Language Student</a></li>
        </ul>
