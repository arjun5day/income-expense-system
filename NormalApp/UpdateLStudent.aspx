<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/NormalApp.Master" AutoEventWireup="true" CodeBehind="UpdateLStudent.aspx.cs" Inherits="OIMS.NormalApp.UpdateLStudent" %>
...
<div class="rightappcontent">
   ...
   <div class="bottommenu">
       <ul>
        <li><a href="../NormalApp/AdmitCStudent.aspx">Admit Language Student</a></li>  
        <li><a href="../NormalApp/UpdateCStudent.aspx">Update Language Student</a></li>
        <li><a href="../NormalApp/DisplayCStudent.aspx">Display Language Student</a></li>
        </ul>
