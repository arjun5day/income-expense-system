<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/NormalApp.Master" AutoEventWireup="true" CodeBehind="AdmitCStudent.aspx.cs" Inherits="OIMS.NormalApp.AdmitCStudent" %>
    ...
    <table class="style1" cellpadding="5px">
        <tr>
            <td colspan="2" style="text-align: center">
                <h4>Computer Student Admission</h4></td>
        </tr>
        <tr>
            <td>
                First Name:</td>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="rqLastName" runat="server" 
                    ...
                    ValidationGroup="AdmitGroup" CssClass="errorMessage"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
...
<div class="rightappcontent">
    <table class="style1" cellpadding="5px">
        <tr>
            <td colspan="2" style="text-align: center">
                <h4>Computer Fee Information</h4></td>
        </tr>
        <tr>
            <td>
                Course:</td>
